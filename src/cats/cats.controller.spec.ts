...
const testCatData = [{ id: 1, name: 'Test cat', age: 5, breed: 'Russian Blue' }, { id: 1, name: 'Test cat admin', age: 2, breed: 'Russian Blue', info: 'test info' }];
...
describe('CatsController', () => {
      ...
      providers: [
        {
          ...
          useValue: {
            ...
            removeCat: jest.fn(),
            getAllCatWithAdminCat: jest.fn(() =>[testCatData])
          },
        },
      ],
    }).compile();
  ...
  it('should get all records', async()=>{
    expect(await controller.getAllCatWithAdminCat()).toEqual([testCatData])
  });
});
